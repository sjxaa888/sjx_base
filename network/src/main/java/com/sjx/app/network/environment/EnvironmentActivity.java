package com.sjx.app.network.environment;
...
public class EnvironmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sCurrentNetworkEnvironment = prefs.getString(EnvironmentActivity.NETWORK_ENVIRONMENT_PREF_KEY, "test");
    }
    ...
    public void onBackPressed() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        String newValue = prefs.getString(EnvironmentActivity.NETWORK_ENVIRONMENT_PREF_KEY, "test");
    ...
    public static String isOfficialEnvironment(Application application) {
        ...
        return prefs.getString(EnvironmentActivity.NETWORK_ENVIRONMENT_PREF_KEY, "test");
    }
}